    ...
    <S.AboutContent>
      ...
      <TextCollapse title="Backstory">
        <p>
          ...
          on Natural Language Processing and Machine Learning, using mainly
          Python.
        </p>
        ...
        <p>
          ...
          job as a developer: a Python Software Development Internship, more
          than 200km away from my college, in a financial market company named
          Vert Capital.{" "}
        </p>
        <p>
        ...
        <ol>
          ...
          <li>
            ...
            background. It was the perfect role for me. I accepted the offer
            with no time;
          </li>
        ...
        <p>
          ...
          my career as a developer for exactly one year. No less, no more. And
          so it went.
        </p>
        <p>
      ...
      <TextCollapse title="Other Facts">
        <ul>
          ...
          <li>
            ...
            unfinished random essays, articles, the british writer texts, poems.
            Some of them are already published, some are going to be when I
            finish building my Digital Garden
          </li>
          <li>
      ...
      <TextCollapse startsExpanded title="Gear">
        <ul>
          <li>
            {" "}
            Primary Laptop: Dell Inspiron 7572, 16GB RAM, 128GB SSD + 1TB HDD{" "}
          </li>
          <li>
            {" "}
            Secondary Laptop:{" "}
            <a
              href="https://support.apple.com/kb/SP714?viewlocale=pt_BR&locale=en_KW"
              target="_blank"
              rel="noopener noreferrer"
            >
              MacBook Air early-2015, 8GB RAM, 128GB{" "}
            </a>{" "}
          </li>
          <li>
            {" "}
            Mouse:{" "}
            <a
              href="https://www.logitech.com/en-us/eol/mx-anywhere-2s-mouse.910-005132.html"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <li>
            Keyboard:{" "}
            <a
              href="https://www.keychron.com/products/keychron-k2-hot-swappable-wireless-mechanical-keyboard"
              target="_blank"
              rel="noopener noreferrer"
            >
      ...
      <TextCollapse title="Linguistics">
        <ul>
          <li>
            I study Linguistics (undergraduate bachelor) at UFSCar, the Federal
            University of São Carlos, one of the most important universities in
            Brazil
          </li>
          <li>
            {" "}
